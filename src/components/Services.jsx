  ...
  return (
    <section id="services" className="bg-cream px-6 py-24 sm:px-10 lg:px-16">
      ...
      {!loading && categories.length === 0 && (
        <p className="mt-14 text-center text-ink/40">
          Aucune catégorie pour le moment — ajoutez-en une depuis l'espace admin.
        </p>
      )}
      ...
      {!loading && categories.length > 0 && (
        ...
        >
          {categories.map((s, i) => {
            ...
            const isWideRow = isLast && categories.length % 2 === 1
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 flex items-end justify-between p-6">
                  <div>
                    ...
                    {s.description && (
                      <p className="mt-2 max-w-[26ch] font-sans text-xs uppercase tracking-wideish text-cream/70">
                        {s.description}
                      </p>
                    )}
                  </div>
